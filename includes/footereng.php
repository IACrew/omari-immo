                ...
                <div class="col-lg-12">
                    <div class="call-to-action-inner call-to-action-inner-6 ltn__secondary-bg text-center---">
                        <div class="coll-to-info text-color-white">
                            <h2>You want to sell or rent your property?</h2>
                            <p>Benefit from our expertise in the field for a maximum services quality and the best conditions in the market.</p>
                        </div>
                        <div class="btn-wrapper">
                            <a class="btn btn-effect-3 btn-white" href="../contact.php">Contact<i class="icon-next"></i></a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-xl-3 col-md-6 col-sm-6 col-12">
                        <div class="footer-widget footer-about-widget">
                            ...
                            <p>OMARI IMMOBILIER the best real estate agency to rent, sell, buy house or land in Morocco.</p>
                                ...
                                <ul>
                                    <li>
                                        ...
                                        <div class="footer-address-info">
                                            <p><a href="tel:+212661198726">+212661198726</a></p>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="footer-address-icon">
                                        ...
                                        <div class="footer-address-info">
                                            <p><a href="mailto:alomariimmobilier@gmail.com">alomariimmobilier.contact@gmail.com</a></p>
                                        </div>
                                    </li>
                                </ul>
                            </div>
                            <div class="ltn__social-media mt-20">
                                <ul>
                                    <li><a href="https://web.facebook.com/omari.immobilier21" title="Facebook"><i class="fab fa-facebook-f"></i></a></li>
                    ...
                    <div class="col-xl-2 col-md-6 col-sm-6 col-12">
                        <div class="footer-widget footer-menu-widget clearfix">
                            <h4 class="footer-title">Omari Services</h4>
                            <div class="footer-menu">
                                <ul>
                ...
                <div class="row">
                    <div class="col-md-6 col-12">
                        <div class="ltn__copyright-design clearfix">
                            <p>All Rights Reserved @ Omari Agence immobilière <span class="current-year"></span></p>
                        </div>
                    </div>
