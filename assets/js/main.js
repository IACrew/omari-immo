    ...
    jQuery(document).ready(function(){
        ...
        */
        ...
        $('.ltn__shop-details-small-img').slick({
            ...
            arrows: true,
            focusOnSelect: true,
            prevArrow: '<a class="slick-prev bg-white"><i class="fas fa-arrow-left" alt="Arrow Icon"></i></a>',
            nextArrow: '<a class="slick-next bg-white"><i class="fas fa-arrow-right" alt="Arrow Icon"></i></a>',
            responsive: [
                {
                    breakpoint: 992,
                    settings: {
        ...
        $('.ltn__testimonial-slider-3-active').slick({
            ...
            slidesToShow: 3,
            slidesToScroll: 1,
            prevArrow: '<a class="slick-prev bg-white bg-white"><i class="fas fa-arrow-left" alt="Arrow Icon"></i></a>',
            nextArrow: '<a class="slick-next bg-white"><i class="fas fa-arrow-right" alt="Arrow Icon"></i></a>',
            responsive: [
                {
                    breakpoint: 1600,
        ...
        $('.ltn__image-slider-3-active').slick({
            ...
            centerPadding: '0px',
            prevArrow: '<a class="slick-prev bg-white bg-white"><i class="fas fa-arrow-left" alt="Arrow Icon"></i></a>',
            nextArrow: '<a class="slick-next bg-white bg-white"><i class="fas fa-arrow-right" alt="Arrow Icon"></i></a>',
            responsive: [
                {
                    breakpoint: 992,
                    settings: {
