				 ...
				 "data":{id:iddelete},
				  success:function(rep1)
				  {
				  	...
				  	$.ajax({
                       ...
                       '<div class="dropdown-menu dropdown-menu-right">'+
                       ' <ul class="link-list-opt no-bdr">'+
                       '<li><a onclick="updateriad('+obj[i]['idm']+')" data-toggle="modal" data-target="#modalTabs"><em class="icon ni ni-edit"></em><span>Mofidier</span></a></li>'+
                        
                       '<li><a onclick="imageriad('+obj[i]['idm']+')" data-toggle="modal" data-target="#modalimage"><em class="icon ni ni-activity-round"></em><span>Modifieir les images</span></a></li>'+
                       '<li><a onclick="removeriad('+obj[i]['idm']+')" id=""><em class="icon ni ni-trash"></em><span>Supprimer</span></a></li>'+
                       '</ul></div></div></li></ul></div></div>').insertAfter("#headtable");
						  	}
