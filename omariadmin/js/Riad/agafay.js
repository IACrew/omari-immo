				 ...
				 "data":{},
				  success:function(rep1)
				  {
				  	...
				  	for (var i = 0; i < obj.length; i++) {
                       ...
                       '<li><a onclick="imageriad('+obj[i]['idm']+')" data-toggle="modal" data-target="#modalimage"><em class="icon ni ni-activity-round"></em><span>Modifier images</span></a></li>'+
