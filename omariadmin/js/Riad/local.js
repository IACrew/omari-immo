...
$(document).ready(function(){
	...
	$('#Ajouter').click(function(){
		...
		form_data3.append('Bedrooms',Bedrooms);
		form_data3.append('Bathrooms',Bathrooms);
		form_data3.append('Levels',Levels);
		form_data3.append('Dining',Dining);
		form_data3.append('Living',Living);
		form_data3.append('AC',AC);
		form_data3.append('Parking',Parking);
		form_data3.append('Internet',Internet);
		form_data3.append('pdf',pdf[0]);
		form_data3.append('video',video);
		form_data3.append('kitchen',kitchen);
		form_data3.append('adresse',adresse);

		
		
		$.ajax({
            "url":"./PHP/VILLA/AjouterQat.php",
            "method":"POST",
            "data":form_data3,
            processData: false,
            contentType: false,
	...
	$("#Modifer").click(function(){
		...
		form_data2.append('Bedrooms',Bedrooms);
		form_data2.append('bathroom',bathroom);
		form_data2.append('Adresse',Adresse);

		//alert('OK');
		$.ajax({
				 "url":"./PHP/VILLA/modifiervilla.php",
				 "method":"POST",
				 "data":form_data2,
				 processData: false,
                 contentType: false,
	...
	$.ajax({
				 ...
				 "data":{id:a},
				  success:function(rep1)
				  {
						...
						$("#Bedrooms").val(obj[0]['bedrooms']);
						$("#bathroom").val(obj[0]['bathrooms']);
