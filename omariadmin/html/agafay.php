                                ...
                                <div class="nk-block-head nk-block-head-sm">
                                    <div class="nk-block-between">
                                        <div class="nk-block-head-content">
                                            <h3 class="nk-block-title page-title">Omari Agafay Camp </h3>
                                    ...
                                    <ul class="nav nav-tabs mt-n3">
                                                ...
                                                <div class="tab-content">
                                                    ...
                                                    <div class="tab-pane" id="tabItem6">
                                                        <label class="form-label">fulfill the characteristics of Agafay Camp</label><br><br>
                                                        <div class="nk-block">
                                                            <div class="row g-3">
                                                                <div class="col-12">
                                                                    <div class="form-group">
                        ...
                        <div class="tab-pane active" id="tabItem1">
                            ...
                            <div class="row g-3">
                                                                ...
                                                                <div class="col-mb-12">
                                                                 ...
                                                                 <div class="col-12">
                                                                    <div class="form-group">
                                                                        <label class="form-label" for="Desc1">Description</label>
                                                                        <div class="form-control-wrap">
                                                                            <textarea class="form-control no-resize" id="Desc1"></textarea>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-12">
