                            ...
                            <div class="nk-content-body">
                                <div class="nk-block-head nk-block-head-sm">
                                    <div class="nk-block-between">
                                        <div class="nk-block-head-content">
                                            <h3 class="nk-block-title page-title">Omari appartement  </h3>
                                ...
                                <div  class="nk-add-product toggle-slide toggle-slide-right" data-content="addProduct" data-toggle-screen="any" data-toggle-overlay="true" data-toggle-body="true" data-simplebar>
                                    <div class="nk-block-head">
                                        <div class="nk-block-head-content">
                                            <h5 class="nk-block-title">Nouveau Immeuble</h5>
                                            <div class="nk-block-des">
                                                <p>Ajouter des informations pour le nouveau Immeuble .</p>
                                            </div>
                                        </div>
                                    </div>
                                    <ul class="nav nav-tabs mt-n3">
                                                    ...
                                                    <li class="nav-item">
                                                        <a id="nav2" class="nav-link" data-toggle="tab" href="#tabItem6"><em class="icon ni ni-lock-alt"></em><span>informations</span></a>
                                                    </li>
                                                    <li class="nav-item">
                                                ...
                                                <div class="tab-content">
                                                    <div class="tab-pane active" id="tabItem5">
                                                        <div class="nk-block">
                                                            <div class="row g-3">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="form-control-wrap">
                                                                            <select class="form-control" id="Statu">
                                                                                ...
                                                                                <option value="locationcd">location Saisonnière</option>
                                                                            </select>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-12">
                                                                    <div class="form-group">
                                                                        <label class="form-label" for="Adresse">Adresee</label>
                                                                        <div class="form-control-wrap">
                                                    ...
                                                    <div class="tab-pane" id="tabItem6">
                                                        <label class="form-label">remplir les caractéristiques d'Immeuble</label><br><br>
                                                        <div class="nk-block">
                                                            <div class="row g-3">
                                                                <div class="col-12">
                                                                    <div class="form-group">
                                                                        <label class="form-label" for="Bedrooms">Chambres</label>
                                                                        <div class="form-control-wrap">
                                                                ...
                                                                <div class="col-mb-12">
                                                                    <div class="form-group">
                                                                        <label class="form-label" for="Bathrooms">Salles de bain</label>
                                                                        <div class="form-control-wrap">
                                                                ...
                                                                <div class="col-mb-12">
                                                                    <div class="form-group">
                                                                        <label class="form-label" for="Levels">niveaux</label>
                                                                        <div class="form-control-wrap">
                                                                ...
                                                                <div class="col-12">
                                                                    <div class="form-group">
                                                                        <label class="form-label" for="kitchen">cuisine</label>
                                                                        <div class="form-control-wrap">
                                                                ...
                                                                <div class="col-12">
                                                                    <div class="form-group">
                                                                        <label class="form-label" for="Dining">Salle à manger</label>
                                                                        <div class="form-control-wrap">
                                                                ...
                                                                <div class="col-12">
                                                                    <div class="form-group">
                                                                        <label class="form-label" for="Living">Le salon</label>
                                                                        <div class="form-control-wrap">
   ...
   <div class="modal fade" tabindex="-1" role="dialog" id="modalTabs">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="tabItem1">
                            ...
                            <div class="row g-3">
                                                                ...
                                                                <div class="col-12">
                                                                    <div class="form-group">
                                                                        <label class="form-label" for="bathroom"> salle de bains</label>
                                                                        <div class="form-control-wrap">
    ...
    <div class="modal fade" tabindex="-1" role="dialog" id="modalimage">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-body modal-body-md">
                    <h4 class="title">mettre à jour les images de l'immeuble</h4>
...
?>
<script src="./js/Riad/app.js"></script>
