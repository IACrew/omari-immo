                                ...
                                <div class="col-md-6">
                                    <div class="input-item">
                                        <select class="nice-select" name="reason">
                                            <option>Select the subject of your message</option>
                                            <option value="Vente immobilier">Real estate sales </option>
                                            <option value="Achat immobilier">Property purchase </option>
                                            <option value="Location de voitures"> Car rental</option>
                                            <option value="Transport touristique">Tourist transport</option>
                                            <option value="Excursions">Excursions & tours</option>
                                            <option value="Conseil">Conseil & accompagnement</option>
                                            <option value="Collaboration">Collaboration en immobilier</option>
                                            <option value="information">Collaboration in real estate</option>
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="ltn__contact-address-item ltn__contact-address-item-3 box-shadow">
                        ...
                        <h3>Email Address</h3>
                        <p></br>alomariimmobilier@gmail.com</p>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="ltn__contact-address-item ltn__contact-address-item-3 box-shadow">
                ...
                <div class="col-lg-4">
                    <div class="ltn__contact-address-item ltn__contact-address-item-3 box-shadow">
                        ...
                        <h3>Address</h3>
                        <p>Lot Al Massar N380 Magasin N3 RTE de safi Marrakech., Marrakech, 40160<p>
                    </div>
                </div>
            </div>
        </div>
