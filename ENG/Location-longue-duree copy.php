                ...
                <div class="col-lg-12">
                    <div class="ltn__breadcrumb-inner">
                        ...
                        <div class="ltn__breadcrumb-list">
                            <ul>
                                <li><a href="../assets/index.html"><span class="ltn__secondary-color"><i class="fas fa-home"></i></span> Location Longue Duree</a></li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <?php
                    $cbd = new CrudBD();
                    $objects= $cbd->list("locationId",$_GET['page']);
